/*******************************************************************
This code is partically based off of the ArduinoSpotify example and the example of Acorn221 https://github.com/Acorn221/SpotifyDisplayLILYGO but edited to work with the T5 v2.8 e-ink screen.
 *******************************************************************/
...
#define MAX_LENGTH_PER_LINE 26
#define uS_TO_S_FACTOR 1000000ULL  /* Conversion factor for micro seconds to seconds */
#define TIME_TO_SLEEP 300
#define PRE_RESTART_TIME 15

//------- Replace the following! ------
const char* ssid = "LiamHotspot";
const char* password =  "instagram";

// Follow the instructions on the ArduinoSpotify "getRefreshToken" example to get all of this
char clientId[] =     "28292185569b4c49a19867cd767357d4";     // Your client ID of your spotify APP
char clientSecret[] = "24f38e8216d146b180fa908a183ce784"; // Your client Secret of your spotify APP (Do Not share this!)

// Country code, including this is advisable
#define SPOTIFY_MARKET "NL"

#define SPOTIFY_REFRESH_TOKEN "AQDjrsZywSqn2mCL7eHeVj3x0becOSrSKOlAR4hU6ATFfrfc6HlqNoAafT9IX27YhWTs0hF8l8bzkiEBK6Vn2uqugZaKoDHYFP6XAWjy-qfCm1E4DtCEZllnslYQCz-ujm8"
